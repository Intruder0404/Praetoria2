<template>
    ...
    >
        ...
        <v-list density="compact" nav>
            ...
            <v-list-item prepend-icon="mdi-account-child-outline" title="Personnage" value="personnage"
                         to="/character"></v-list-item>
            <v-list-item prepend-icon="mdi-human-male-female-child" title="Family" value="family"
